...
rivals:
  - orc-steppe-confederations
  - chain-breakers-order
controls:
  - samarkand
  - bukhara
  - balkh
  ...
  - dunhuang
  - jade-gate
  - all-major-silk-road-hubs
narrative_weight: very-high
status: canon
created: 2026-04-14
last_updated: 2026-04-14
tags:
  - gm-only
  - campaign-arc-backstory
  - historical
---

# The Human Empire

> ⚠️ **Stub — basic pass only.** Key design questions unresolved: ruling structure, fantasy name, and Wizard relationship. Do not share with players. See DM Notes.
...
**Fantasy name:** TBD — needs a dedicated naming session before this file advances beyond stub.

**Open question:** Who ran it? Three candidate models:
- A ruling dynasty (hereditary, blood-claim to power)
- A priestly or scholarly caste (cosmological knowledge as the basis of authority — consistent with binding magic)
- A military aristocracy (conquest as legitimacy — consistent with the slave-legion structure)
...
**Administration:** Bureaucratic. City-level administration controlled all major Silk Road hubs. The remnants of this administrative apparatus survive as the Human Imperial Remnants — the bureaucratic facade outlasted the empire that created it.

---

## Relationship to Power

**Visible face:** Absolute territorial authority. Walls, seals, renamed cities, languages of authority. The Empire was loud by design — visibility was the point.

**Hidden influence:** The binding magic that controlled the Orc slave-legions. This was not public knowledge in the sense of being understood — it was experienced as simply how the world worked. The cosmological mechanism behind it was held by a small number of people, possibly only one.

**Leverage:** Military (Orc slave-legions), trade monopoly (all major Silk Road hubs), and the binding magic itself — which is the deepest leverage of all, because it was not just coercive but ontological.
...
|---------|-------------|-------|
| [[human-imperial-remnants\|Human Imperial Remnants]] | legacy / successor fragment | The administrative structure that outlasted the Empire; the facade without the force |
| [[orc-confederation-samarkand\|Orc Confederation (Samarkand)]] | former controlled | Rose from the slave-legion structure post-liberation |
| [[orc-steppe-confederations\|Orc Steppe Confederations]] | rival / enslaved | The source population for the slave-legions |
| [[chain-breakers-order\|Chain-Breakers Order]] | opposed | Founded in direct response to the liberation; carries memory of the Empire's mechanisms |
| [[lich-cadre\|Lich Cadre]] | relationship unclear | The Wizard's relationship to the Empire is an open design question — see DM Notes |
| [[the-wizard\|The Wizard]] | relationship unclear | Predates, rises within, or was created by the Empire? Gates significant design decisions |
| [[scholars-remnant\|Scholars' Remnant]] | opposed / hunted | The Scholar's Purge targeted knowledge of the Empire's mechanisms specifically |

---

## DM Notes

**The Wizard question** is the central unresolved issue for this file. Three options, per prior design sessions:
- **A:** The Wizard predates the Empire and was its architect or patron
- **B:** The Wizard rose within the Empire, possibly as its cosmological specialist (the person who held the binding knowledge)
- **C:** The Wizard was created or empowered by the Empire's fall — a being who emerged from the disruption of the liberation event
