...
**The dread visage:** Not a weapon — a condition. The shift in appearance that surfaces under strong emotion is something the Div-Born lives with, not deploys. That said, when it surfaces in a tense negotiation, it tends to clarify the situation rapidly. Whether that is useful depends on what outcome the Div-Born wanted.

**The infernal resilience:** Div-Born carry something from the Outer Reaches in their physical constitution that makes them harder to diminish than their appearance might suggest. Within Div-Born culture this is understood as the inheritance being protective as well as complicated — the Outer Reaches shaped beings who endure.
...
- Scholar purge connection: what do Div-Born contract archives contain about the liberation era? Their records may be more complete than most — contracts were made during the chaos period that no one wanted remembered. Flag for `world/ancestries/gm_secrets/infernis_gm.md`.
- The Outer Reaches relationship to the Warren: needs coordination with cosmological architecture. Are the Outer Reaches below the Warren, adjacent to it, or something else? This affects how Div-Born characters interact with R/H/K mechanics.
- Named crossroads communities: TBD — tie to `/world/` locations.
- Relationship with the Wizard: if the Wizard has awareness of the Outer Reaches or interest in what lies below the Warren, Div-Born communities may have been approached, pressured, or used. Flag for GM secrets.
