---
title: Session 0 GM Notes — Execution Guide
...
# Session 0 GM Notes — Execution Guide
...
## Before You Read the Scenarios

**The one thing that makes Session 0 work:** The players must believe the world cares about their character before they care about it themselves. Your job in the first 45 minutes is not to run a mystery — it's to make the player feel seen. Every atmospheric detail, every patient NPC, every moment of restraint you model teaches the table what kind of game this is. That promise only needs to be made once. After the Warrior's awakening, your players know. The rest of Session 0 can move faster, lighter, because trust is already earned.

**The dual-truth contract:** You know the cosmological facts. They don't. The snippets give emotional truth, not explanatory truth. Every time you're tempted to let something slip — a name, a reason, a "before" — catch it. The recognition climax at the end of the session lands harder in proportion to how much you've held back.
...
## Act 2: Convergence Orchestration
