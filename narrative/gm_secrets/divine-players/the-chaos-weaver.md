...
alignment: welcoming-dissolution
tags:
  - gm-only
  - divine-player
  - pre-cosmic
...
> *The Chaos Weaver is not addressed. It is diagnosed. Cultures name the wound, not the wound-maker — what is observed, feared, or experienced as the failure of the ordered world. Usage notes here reflect that epistemic shift.*
...
**What it is:** Not a person. A principle that has accumulated enough will to act directionally. It represents everything the Mythic Ecosystem was designed to contain — not evil from outside, but the null condition that the ecosystem's existence prevents. The Hundun story is exact: any well-intentioned boring of apertures into Hundun kills something that had its own integrity. The Chaos Weaver's thesis is that the ordered world was a mistake from the beginning, and the mistake is getting louder.
...
**What it does:** Manifests as the failure modes of the ordered world, intensifying in proportion to existing instability. Not creating the instability — occupying and widening it.
...
> *Use when the heroes are in territory actively affected by the Chaos Weaver — a region where wrong-directed failure is present, a scene where formlessness is gaining ground, or an encounter where the condition is the encounter itself.*

```daggerheart
name: Wrong-Directed Territory
difficulty: 17
tone: Wrong, Directionless
impulses:
...
features:
  - name: Wrong Direction
    type: Passive
    desc: |
      All failures in this territory produce wrong-directed outcomes — not larger obstacles but different-kind obstacles. The situation after failure is more confused than more difficult. Heroes tracking the direction of failures will notice the pattern before they can name it. GMs should make the wrong-direction visible as a consistent quality, not as randomness.
      GM question: What does wrong-directed failure look like in this specific region? What do the locals call the quality of the place? What has it cost them that they cannot explain?
  - name: Virtue Trap
    type: Active
    desc: |
      At a high-stakes moment, one hero's most prominent virtue becomes structurally exposed. The scene is designed — not by anyone — to make that virtue a disadvantage. The trap is not set; it is discovered. Heroes who recognize the pattern (Difficulty 15 Instinct roll) can name it in time to adapt. Heroes who don't find out afterward.
      GM question: Which hero's virtue is most exposed in this scene? How does the specific situation convert it from strength to vulnerability? The conversion should be specific and legible in retrospect.
  - name: Coherence Failure
    type: Escalation
    desc: |
      When the Chaos Weaver's influence reaches critical density in a region — repeated hero failures, proximity to a major cosmological event, or the Threshold pressure spiking — coherence itself fails. NPCs cannot sustain their own intentions. Plans disintegrate from within before external pressure. The heroes must navigate a situation where the normal assumption — that deliberate action produces predictable consequences — has been locally suspended.
      GM question: What is the visible sign of coherence failure in this specific place? What do the heroes still have that the Chaos Weaver cannot reach?
```
