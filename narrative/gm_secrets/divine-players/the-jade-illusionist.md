...
cosmological_layer: Celestial-adjacent
alignment: trickster
tags:
  - gm-only
  - divine-player
...
**What they want:** The most interesting possible outcome. Not suffering — *interesting*. These are different, and the Jade Illusionist understands the difference precisely. They will genuinely help the heroes if that makes the story better. They will genuinely complicate things if that also makes the story better. The complication of genuine help and genuine interference coexisting is something they find natural; the distinction matters less than whether the scene is worth watching.
...
> *The Jade Illusionist does not confront. This block represents the rare encounter where they have chosen to remain present long enough that the scene becomes structured — a formal revelation, a test of genuine engagement, or the heroes forcing a confrontation that they cannot quite sustain. The Jade Illusionist finds being "confronted" mildly amusing.*

```daggerheart
name: The Jade Illusionist
tier: 4
type: Solo
difficulty: 17
thresholds: 20 / 35
hp: Variable — see Shifting Form
stress: 4
attack: The Right Question
range: Presence
damage: 2d10+4 psychic (the weight of a truth delivered at exactly the wrong moment)
motives: Interest; the best possible outcome for the story; revelation at the structurally correct moment
xp: Cosmological revelation; confirmation of something the heroes suspected but could not prove; the Jade Illusionist's acknowledgment that they've been watching
features:
  - name: Shifting Form
    type: Passive
    desc: "At the start of each round, the Jade Illusionist may shift their apparent form. When they do, reset their HP to the current pool's maximum. This represents their genuine cosmological nature, not a combat mechanic — the form the heroes are fighting is never quite the real thing. A hero who abandons the fight and asks a genuine question instead causes this feature to end."
  - name: Already Knew That
    type: Reaction
    desc: "When a hero uses knowledge or ability the Jade Illusionist has not seen before, they pause. The next action they take is to ask a question — not an attack. Heroes who answer honestly gain Advantage on their next roll. Heroes who deflect or lie (which the Jade Illusionist will know) gain nothing, and the Jade Illusionist moves on."
  - name: The Worst Possible Moment
    type: Action
    desc: "The Jade Illusionist delivers a revelation. The hero it targets must succeed on a Presence roll (Difficulty 17) or become Vulnerable until end of scene — not from harm, but from the processing load of genuine truth at maximum inconvenience. Heroes who succeed take the information fully and may act on it immediately."
```
