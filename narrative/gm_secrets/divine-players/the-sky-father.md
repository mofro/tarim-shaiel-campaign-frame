...
> *The Sky-Father is named through address and attribute, not through invitation. Shamanic traditions speak to the sky itself; the name is the weather, the direction, the quality of light.*
...
> *Use when heroes are operating in territory where the Sky-Father's active attention is present — a Steppe region during a significant cosmological moment, a shamanic site with open Sky-Father connection, or a scene where the equilibrium is being tested directly. The heroes are inside the condition; they are not fighting it.*

```daggerheart
name: The Sky-Father's Attention
difficulty: 16
tone: Vast, Witnessing
impulses:
...
features:
  - name: Everything Is Permitted (That Is Not Prevented)
    type: Passive
    desc: |
      While in Sky-Father territory, all hero rolls that move toward genuine completion of their charge receive no mechanical bonus — but terrain, weather, and NPC cooperation default to the slightly-easier-than-usual end of ambiguous outcomes. This is not magic; it is the structural friction of the world being slightly more on their side. Heroes who are working against their charge find the ordinary world slightly more resistant.
      GM question: What does "slightly easier" look like in this specific terrain and season? What does the shaman sense that he cannot name?
  - name: The Fragment
    type: Active
    desc: |
      At a structurally significant moment — hero decision point, revelation near, or accumulated cost becoming visible — the Sky-Father delivers a fragment through whatever channel is available. The fragment is cosmologically accurate. Its application is the heroes' problem.
      GM question: What fragment is appropriate for where the heroes are in the arc? What has the Sky-Father decided they are ready to receive at this moment?
  - name: The Cost of Inaction Visible
    type: Escalation
    desc: |
      When the heroes' situation has deteriorated significantly — when the cost of the Sky-Father's inaction is becoming directly legible in what they have lost — the Sky-Father opens a channel he had been holding closed. A shaman speaks more clearly. A weather pattern resolves into a route. The information available escalates. This is not help. This is the debt of watching being partially acknowledged.
      GM question: What has the Sky-Father been withholding that becomes available here? What does it mean that he chose this moment?
```
