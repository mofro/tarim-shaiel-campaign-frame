...
> *The Memory-Keeper is approached through practice, not address. It does not have names in the way personal beings have names. It is what ancestor veneration is reaching toward when it succeeds in reaching something real.*
...
**What it does:** Waits. Paces. Holds the candle.
...
> *Use when heroes are operating at or near a Memory-Keeper root-site — an active ancestor ceremony reaching the deep archive, a Dwarven archive with unusual depth, a dream-adjacent scene near a significant Warren-site, or the moment of the full revelation in Act III.*

```daggerheart
name: The Memory-Keeper's Presence
difficulty: 14
tone: Ancient, Patient
impulses:
...
features:
  - name: Paced Return
    type: Passive
    desc: |
      The Memory-Keeper adjusts what is available to what the heroes can currently receive. Heroes who attempt to force access to more than they have prepared for receive only what they are ready for — the additional material is present, inaccessible, and leaves a felt sense of incompletion. This is not a failure; it is the Memory-Keeper doing its primary work.
      GM question: What is the heroes ready to receive at this point in the arc? What should they feel is available but not yet accessible? What signal will tell the GM they are ready for the next piece?
  - name: What It Cost
    type: Active
    desc: |
      At a Memory-Keeper site or during a functional ancestor ceremony, the heroes receive not just information but the weight of what the thousand-year absence cost. This is not debilitating — it is the cost of receiving the truth. Each hero learns something specific that their absence allowed to happen. This is the Memory-Keeper being honest, not cruel.
      GM question: What specifically did each hero's absence cost that is legible from the archive? Choose one thing per hero. Make it specific. Make it true.
  - name: The Full Picture
    type: Escalation
    desc: |
      Act III only. When heroes have assembled the complete external synthesis and are ready for the internal piece, the Memory-Keeper opens the archive fully. This is a scene, not a roll — the heroes receive everything, in the form that is most specific to who they are now. The charge in full. What it required of them a thousand years ago. What it requires of them now. The difference between the stories and the truth.
      GM question: How does each hero's recovered self integrate with the full truth of what their charge actually demands? What has changed in them during the campaign that allows them to receive what they could not have received at the beginning?
```
