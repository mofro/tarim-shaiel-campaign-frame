...
notes: |
  ...
  GM-facing sections: Distinctions onward. Marked clearly. See GM document for full picture.
  Secrets excluded: origins/exile, the antagonist, the Lich-Legion, the Celestial Peak,
  the Fallen Companion, the Gaes. The 1000-year gap is GM-facing.
aliases:
banner: https://images5.alphacoders.com/798/thumb-1920-798802.jpg
banner-x: 57
banner-y: 4
banner-height: 380
banner-fade: -35
...
Dark Fantasy · Morally Grey · Weighty · Intimate · Consequential

---

## Themes

- **The weight of a name.** Your characters carry significance they didn't choose and can't fully account for. The name means something to the world. Whether it means the same thing to you is the question.

- **Choosing despite doubt.** This is not a campaign about certainty. It is a campaign about making choices anyway: under pressure, with incomplete information, knowing the cost may not be clear until later.

- **The long shadow of consequence.** Every action here casts a shadow. The campaign asks players to sit with outcomes, to let them mean something rather than immediately move past them.

- **A world still healing.** Liberation is not the same as peace, and peace is not the same as justice. The world the characters move through is still working that out. Some of it is raw. Some of it has calcified into myth. None of it is finished.

- **What it costs to matter.** The characters are significant. That significance was not free. Someone paid. Some of them are still paying. The campaign, over time, asks its characters to look at that directly.

---

## Touchstones

> *[GM: Confirm and add to this list. Suggestions below — use what fits your table's frame of reference.]*

*Gardens of the Moon* (Erikson) · *[Add 2–3 more — fiction, film, or other RPGs that set the right tonal expectation for your table]*

The throughlines to look for: moral complexity without nihilism, consequence that compounds, characters who are genuinely changed by what they do, worlds with a deep and lived-in history that wasn't built for the protagonists.
...
%% 
> [!tip] *Player-facing. One page. Sets the world without revealing the premise.* 
...
> *A character creation guide with expanded guidance on approaches will be provided at Session Zero.*

---

## Player Principles

Follow these principles to stay in the right relationship with the campaign's themes. They are not rules. They are the mindset that makes the campaign work.
...
Eight regions. Names, rough geography, and the political shape of the post-imperial world. Space left intentionally for table contributions.

---
 %%

*Tarim Shaiel · Campaign Frame v2.0 · Daggerheart · March 2026*
