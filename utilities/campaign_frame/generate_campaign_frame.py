...
# ---------------------------------------------------------------------------
# CSS is now linked externally from /assets/css/tokens.css + /assets/css/page-campaign.css
# Source: utilities/shared/css/page-campaign.css
# The cover image URL is injected as an inline style on .cover-image at render time.
# ---------------------------------------------------------------------------
...
def build_html(sections: dict[str, str], version: str = 'v2.0') -> str:
    ...
    cover_image_url_escaped = escape(COVER_IMAGE_URL)
...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/page-campaign.css">
</head>
<body>
...
<div class="page-wrap">
  ...
  <!-- COVER -->
  <div class="cover">
    <div class="cover-image" style="background-image: url('{cover_image_url_escaped}');"></div>
...
class _Generator:
    name = "campaign-frame"
    description = "Generate campaign frame HTML from Markdown source"
