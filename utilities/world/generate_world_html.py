...
# world-base.css      — shared base (both myth/lore and timeline)
# world-myth.css      — myth/lore-specific additions
# world-timeline.css  — timeline-specific additions
# ---------------------------------------------------------------------------
...
generator = make_generator(
    "world",
    "Generate styled HTML for a single myth/lore/timeline doc",
    main,
)
