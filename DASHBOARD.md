...
players:
  ...
  archetypes:
    ...
    - {name: Breaker,    status: deciding,   player: "Erik",  character: "Tadbir / Sorcerer — deciding vs Seeker"}
    - {name: Seeker,     status: deciding,   player: "Erik",  character: "Tadbir / Sorcerer — deciding vs Breaker"}
